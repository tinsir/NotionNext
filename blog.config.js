...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '6c30d7094787457aa9c626d868db0dce,en:6c30d7094787457aa9c626d868db0dce',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个小糖人, Hi，我是一个干饭人,Hi，我是一个汽车人,欢迎来到我的博客🎉',


  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '糖糕游记', // 您的昵称 例如 tangly1024.
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'tanggaoyouji@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/qiaxiaodounianhua', // 你的微博个人主页.
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页.
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/432300098', // B站主页
  ...
  FONT_URL: [
    ...
    'https://cdn.staticfile.net/lxgw-wenkai-webfont/1.7.0/style.css',
  ...
  FONT_AWESOME:
    ...
    'https://lib.baomitu.com/font-awesome/6.5.1/css/all.min.css', // font-awesome 字体图标地址; 可选 /css/all.min.css ， https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css
  ...
  // tin 默认是article 20240602修改为category
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://cdn.staticfile.net/twikoo/1.6.36/twikoo.min.js', // twikoo客户端cdn https://cdn.staticfile.net/twikoo/1.6.17/twikoo.min.js
